...
export const AllocationRow = ({ allocation, onDelete, onEdit, showDelete = true }) => {
          ...
          <div className="inline-flex items-center justify-center gap-0.5">
            {onEdit ? (
              <button
                ...
                className="inline-flex items-center justify-center w-9 h-9 rounded-lg text-gray-400 dark:text-gray-500 hover:text-[#E60012] dark:hover:text-red-400 hover:bg-[#E60012]/10 dark:hover:bg-red-900/20 transition-colors"
              >
