...
export const OverviewTableEmpty = () => {
  return (
      ...
      <div className="flex flex-col items-center justify-center text-center space-y-4">
        <div className="relative">
          ...
          <div className="absolute -bottom-1 -right-1 w-8 h-8 rounded-full bg-gray-200 dark:bg-gray-700 flex items-center justify-center">
            <FileX className="w-4 h-4 text-gray-500 dark:text-gray-400" />
          </div>
        </div>
        ...
        <div className="space-y-2">
          ...
          <p className="text-sm text-gray-500 dark:text-gray-400 max-w-sm">
            There are no recent activities to display at the moment. New activities will appear here as they occur.
          </p>
        </div>
      </div>
    </div>
