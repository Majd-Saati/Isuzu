...
export const PerformanceChartEmpty = () => {
  return (
      ...
      <div className="flex flex-col items-center justify-center text-center space-y-4">
        <div className="relative">
          <div className="w-24 h-24 rounded-full bg-gradient-to-br from-[#E60012]/10 dark:from-[#E60012]/20 to-[#F38088]/10 dark:to-[#F38088]/20 flex items-center justify-center">
            <BarChart3 className="w-12 h-12 text-[#E60012]" />
          </div>
        ...
        <div className="space-y-2">
          <h3 className="text-xl font-bold text-gray-900 dark:text-gray-100">No Performance Data</h3>
          <p className="text-sm text-gray-500 dark:text-gray-400 max-w-md">
            There is no performance data to display at the moment. Once dealer activities are tracked, performance metrics will appear here.
          </p>
        </div>
        ...
        <div className="pt-4">
          <div className="inline-flex items-center gap-2 px-4 py-2 bg-gray-50 dark:bg-gray-800 rounded-lg border border-gray-200 dark:border-gray-700">
            ...
            <span className="text-xs text-gray-600 dark:text-gray-300 font-medium">Ready to track performance</span>
          </div>
        </div>
      </div>
    </div>
