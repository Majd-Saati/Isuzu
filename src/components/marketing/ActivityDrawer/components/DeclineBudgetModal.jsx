...
import { XCircle, Clock, X, Loader2 } from 'lucide-react';
import { formatCurrency } from '../utils/formatters';

export const DeclineBudgetModal = ({ isOpen, onClose, onConfirm, budget, isLoading }) => {
    ...
    <>
      ...
      <div className="fixed inset-0 z-[10001] flex items-center justify-center p-4">
        <div className="bg-white dark:bg-gray-900 rounded-2xl shadow-2xl w-full max-w-md animate-scale-in">
          {/* Header */}
          <div className="p-6 border-b border-gray-200 dark:border-gray-700 bg-gradient-to-r from-red-50 dark:from-red-900/20 to-transparent rounded-t-2xl">
          ...
          <div className="p-6">
            ...
            <div className="bg-gray-50 dark:bg-gray-800 rounded-xl p-4 border border-gray-200 dark:border-gray-700 space-y-3">
              ...
              <div className="flex items-center justify-between">
                ...
                <span className="text-sm font-bold text-red-600 dark:text-red-400">{formatCurrency(budget?.value)}</span>
              </div>
              {budget?.description && (
          ...
          <div className="flex items-center gap-3 p-6 border-t border-gray-200 dark:border-gray-700 bg-gray-50/50 dark:bg-gray-800/50 rounded-b-2xl">
            ...
            <button
              onClick={onConfirm}
              disabled={isLoading}
              className="flex-1 px-4 py-3 rounded-xl text-sm font-semibold text-white bg-red-600 hover:bg-red-700 transition-all disabled:opacity-50 flex items-center justify-center gap-2"
            >
              {isLoading ? (
                <>
