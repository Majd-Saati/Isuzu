...
import { Megaphone, Send, CheckCheck, Clock } from 'lucide-react';
 ...
 */
export const RemindersPageHeader = ({ stats }) => (
    ...
    <div className="flex items-start gap-4">
      ...
      <div>
        ...
        <p className="mt-1 text-sm text-gray-600 dark:text-gray-400">
          Send announcements to your dealers and monitor whether they have been
          delivered and read.
        </p>
      </div>
    </div>
